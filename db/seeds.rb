...
user1 = User.create(username: 'chae', password: 'password', email: 'chae@chae.com')
user2 = User.create(username: 'david', password: 'password', email: 'david@david.com')
